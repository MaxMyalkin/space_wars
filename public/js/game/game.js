...
function(Class, Player, GameMechanic, Resources, GameOver){
 ...
 не скрывать форму при нажатии на кнопку и блокировать её
 с localstorage посылать данные на сервер синхронно
 выбор звука в зависимости от браузера
 плавное ускорение/замедление
 сделать нормальную загрузку в начале игры
 сброс информации в баре плохо работает(возможно уже нормально)
